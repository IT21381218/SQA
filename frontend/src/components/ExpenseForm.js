...
const ExpenseForm = ({ expense, onSubmit, onCancel, categories, isEditing = false }) => {
  ...
  useEffect(() => {
    if (expense) {
      ...
      // But we can show the filename if it exists
      if (expense.receipt) {
        const receiptPath = expense.receipt.split('/').pop();
        setFileName(receiptPath);
      }
    } else {
      ...
      <form onSubmit={handleSubmit} className="expense-form">
        <div className="form-grid">
          ...
          <div className="file-input-group full-width">
            <label className="file-input-label">Receipt (Optional)</label>
